...
export default {
    ...
    methods: {
        ...
        async createBurger(e) {
            ...
            //criar um objeto com tudo que foi preenchido
            const data = {
                nome: this.nome,
                pao: this.pao,
                carne: this.carne,
            ...
            //transformar em texto/JSON para ser interpretado
            const dataJson = JSON.stringify(data);


            //configurar o post para o 'banco' por meio de re
            ...
            //limpar os campos após os pedido
            this.nome = "";
            this.pao = "";
            this.carne = "";
            this.opcionais = "";
